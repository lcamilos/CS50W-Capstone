...
def create_teacher(request):
    if request.method == "POST":
        ...
        if forms.is_valid():
            forms.save()
        messages.success(request, "Coach Registration Successfully!")
...
def edit_teacher(request, pk):
    ...
    if request.method == "POST":
        ...
        if edit_teacher_forms.is_valid():
            ...
            messages.success(request, "Edit Coach Info Successfully!")
            return redirect("teacher_list")
...
def delete_teacher(request, teacher_id):
    ...
    messages.success(request, "Delete Coach Info Successfully")
    return redirect("teacher_list")
